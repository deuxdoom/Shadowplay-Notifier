...
from component.app import MonitorApp  # noqa: E402
...
SETTINGS = {
    "dirs": [WATCH_DIR], "outdirs": [], "patterns": DEFAULT_PATTERNS,
...
# 실제 앱과 같게 ✕ 와 전체화면 버튼을 연결합니다.
app.attach_close(lambda _event=None: root.destroy())

if MODE == "long":
    path = os.path.join(WATCH_DIR, "Modern Warfare 4 - Beta",
                        "Modern Warfare 4 - Beta 2026.09.07 - 11.20.33.04.mp4")
else:
    path = os.path.join(
        WATCH_DIR, "OnimushaWotS",
...
app.add_log("[중단] OnimushaWotS\\Onimusha 2026.09.07 - 10.02.11.DVR.mp4 "
            "(증가 멈춤, 0:24:22, 3.7 GB)", theme.C_SKY)
